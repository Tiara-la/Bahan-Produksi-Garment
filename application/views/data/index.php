...
<div class="container-fluid">
    <div class="row">
        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-md-6">
                    <a href="<?php echo base_url(); ?>data/tambah" class="btn btn-success">Tambah Data Bahan Produksi</a>
                </div>
            </div>
                    ...
                    <table class="table">
                        ...
                        <tbody>
                            ...
                            ?> <tr>
                                    ...
                                    <th><?= $bhn['jenis']; ?></th>
                                    <td>
                                        <a href="<?= base_url(); ?>data/ubah/<?= $bhn['kode_bp']; ?>" class="badge badge-primary">edit</a>
                                        <a href="<?= base_url(); ?>data/edit/<?= $bhn['kode_bp']; ?>" class="badge badge-primary tombol-hapus">hapus</a>
